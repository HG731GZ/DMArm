...
namespace ZLGCAN
{
    ...
    public class Method
    {
		...
		[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
		public static extern uint ZCAN_SetValue(IntPtr device_handle, string path, ref ZCANFD_AUTO_TRANSMIT_OBJ auto);
		...
		[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
		// pTransmit -> ZCAN_TransmitFD_Data
		public static extern uint ZCAN_TransmitFD(IntPtr channel_handle, ref ZCAN_TransmitFD_Data pTransmit, uint len);
		//[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
		//// pTransmit -> ZCAN_TransmitFD_Data
		//public static extern uint ZCAN_TransmitFD(IntPtr channel_handle, ref ZCAN_TransmitFD_Data[] pTransmit, uint len);
		[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
		// pTransmit -> ZCAN_TransmitFD_Data
		public static extern uint ZCAN_TransmitFD(IntPtr channel_handle, ref ZCANDataObj pTransmit, uint len);

		[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        // pTransmit -> ZCAN_TransmitFD_Data
        public static extern uint ZCAN_TransmitData(IntPtr device_handle, IntPtr pTransmit, uint len);
		[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
		public static extern uint ZCAN_TransmitData(IntPtr channel_handle, ref ZCANDataObj pTransmit, uint len);
		//[DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
		//// pTransmit -> ZCAN_TransmitFD_Data
		//public static extern uint ZCAN_TransmitData(IntPtr channel_handle, ref ZCANDataObj[] pTransmit, uint len);
